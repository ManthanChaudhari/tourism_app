...
export default function EditLocationPage() {
  ...
  const [slugGenerated, setSlugGenerated] = useState(false) // Track if slug is auto-generated
  ...
  useEffect(() => {
    ...
    if (slugGenerated && formData.name && originalData) {
      const generatedSlug = generateSlug(formData.name)
      setFormData(prev => ({ ...prev, slug: generatedSlug }))
    }
  }, [formData.name, slugGenerated, originalData])
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Loading location details...</p>
          </div>
        </div>
