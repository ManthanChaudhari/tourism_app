        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
          ...
          <div className="flex flex-col space-y-3 w-full md:w-auto items-center md:items-start">
            ...
            <div className="flex items-center space-x-4 text-sm md:hidden">
              ...
              <Link href="/terms" className="text-gray-300 hover:text-white transition-colors whitespace-nowrap">
                Terms & Conditions
              </Link>
              <span className="text-gray-500">|</span>
              <div className="flex items-center space-x-2 text-gray-300 whitespace-nowrap">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <span className="text-gray-500">|</span>
            <div className="flex items-center space-x-2 text-sm text-gray-300 whitespace-nowrap">
              <svg className="w-4 h-4 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <span>+1 (555) 123-4567</span>
