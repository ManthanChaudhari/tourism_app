        ...
        >
          <Card className="border border-gray-200/50 bg-white shadow-lg rounded-2xl overflow-hidden">
            <CardContent className="p-0 relative">
              <div className="relative min-h-[550px] flex items-center justify-end">
                ...
                <div className="absolute inset-0 overflow-hidden">
                  ...
                  {/* Premium Packages badge */}
                  <motion.div
                    className="absolute top-6 left-6 bg-white/90 backdrop-blur-sm text-gray-700 px-4 py-2 rounded-lg font-medium text-sm shadow-sm border border-gray-200/30"
                ...
                <div className="relative z-10 w-full lg:w-[38%] lg:mr-1 p-1 lg:pl-8 lg:pr-0 flex flex-col justify-center min-h-[550px]">
                  <motion.div
                    className="mb-5"
                  ...
                  >
                    <div className="inline-flex items-center gap-2 text-orange-600 text-xs font-medium mb-3 uppercase tracking-wide">
                  ...
                  <motion.p
                    className="text-white mb-6 leading-relaxed text-sm lg:text-base"
                    initial={{ opacity: 0, x: 30 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true }}
                  ...
                  >
                    <motion.button
                      className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-medium text-sm shadow-md hover:shadow-lg transition-all duration-200"
                      whileHover={{ y: -1 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      Explore Packages
